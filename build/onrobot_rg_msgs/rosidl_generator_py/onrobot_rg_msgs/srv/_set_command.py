...
class Metaclass_SetCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'onrobot_rg_msgs.srv.SetCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from onrobot_rg_msgs.srv import _set_command
...
class SetCommand(metaclass=Metaclass_SetCommand):
    from onrobot_rg_msgs.srv._set_command import SetCommand_Request as Request
    from onrobot_rg_msgs.srv._set_command import SetCommand_Response as Response
