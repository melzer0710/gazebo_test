...
#include "onrobot_rg_msgs/srv/detail/set_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const onrobot_rg_msgs::srv::SetCommand_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  onrobot_rg_msgs::srv::SetCommand_Request & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = onrobot_rg_msgs::srv::SetCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const onrobot_rg_msgs::srv::SetCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<onrobot_rg_msgs::srv::SetCommand_Request *>(
    untyped_ros_message);
...
{
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, onrobot_rg_msgs, srv, SetCommand_Request)() {
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_onrobot_rg_msgs
cdr_serialize(
  const onrobot_rg_msgs::srv::SetCommand_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  onrobot_rg_msgs::srv::SetCommand_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = onrobot_rg_msgs::srv::SetCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const onrobot_rg_msgs::srv::SetCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<onrobot_rg_msgs::srv::SetCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, onrobot_rg_msgs, srv, SetCommand_Response)() {
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand_Response__handle;
}
...
{
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, onrobot_rg_msgs, srv, SetCommand)() {
  return &onrobot_rg_msgs::srv::typesupport_fastrtps_cpp::_SetCommand__handle;
}
